...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { asj: @query.asj, email: @query.email, name: @query.name, phone: @query.phone, place: @query.place } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { asj: @query.asj, email: @query.email, name: @query.name, phone: @query.phone, place: @query.place } }
